...
.field static final RESTART_DIRECT_KEY_TIMEOUT:I = 0x7d0
...
.field mAfterKilledNotAudoStart:Z
...
.field mDirectRestartDialog:Landroid/app/ProgressDialog;

.field private final mDirectRestartLongPress:Ljava/lang/Runnable;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDirectRestartLongPress:Ljava/lang/Runnable;

    .line 770
    iput-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDirectRestartDialog:Landroid/app/ProgressDialog;
    ...
    .line 3462
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAfterKilledNotAudoStart:Z
...
.method static synthetic access$300(Lcom/android/internal/policy/impl/PhoneWindowManager;)Ljava/lang/Runnable;
    .locals 1
    .parameter "x0"

    .prologue
    .line 166
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDirectRestartLongPress:Ljava/lang/Runnable;
...
.method private handleLongPressOnHome()V
    ...
    const v8, #android:integer@config_longPressOnHomeBehavior#t
    ...
    invoke-virtual {p0, v7}, Lcom/android/internal/policy/impl/PhoneWindowManager;->sendCloseSystemWindows(Ljava/lang/String;)V
    ...
    :cond_3
    :goto_0
    const-string v7, "ontim.ft.home.disable"
    ...
    .line 890
    :cond_4
    const-string v7, "ontim.cit.home.test"
    ...
    .line 891
    .local v0, citHomeTest:I
    if-ne v0, v10, :cond_5

    .line 892
    const-string v7, "PhoneWindowManager"

    const-string v8, "cit is ongoing, Ignoring HOME Long pressed;"

    invoke-static {v7, v8}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 893
    const-string v7, "ontim.ft.home.press"
    ...
    .line 911
    .end local v0           #citHomeTest:I
    :cond_5
    :goto_1
    return-void

    .line 885
    .end local v1           #citOnging:I
    :catch_0
    move-exception v3
    ...
    const-string v8, "RemoteException when showing recent apps"
...
.method private interceptPowerKeyUp(Z)Z
    ...
    const-string v3, "interceptPowerKeyUp canceled: "
    ...
    iget-object v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mDirectRestartLongPress:Ljava/lang/Runnable;

    invoke-virtual {v1, v2}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    .line 675
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->hideDirectRestartDialog()V
...
.method private isSysoffEnable()Z
    .locals 6
    ...
    .line 3546
    invoke-interface {v3}, Landroid/os/ISysoffMonitor;->isSysoffEnable()Z
    :try_end_0
    ...
    const-string v5, "Failed to fetch the sysoff status"
...
.method private takeScreenshot()V
    ...
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mAfterKilledNotAudoStart:Z
...
.method public addStartingWindow(Landroid/os/IBinder;Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;III)Landroid/view/View;
    ...
    invoke-virtual {v8, v0}, Landroid/view/Window;->setIcon(I)V
...
.method public beginLayoutLw(ZIII)V
    ...
    iget-boolean v2, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasWallpaper:Z
...
.method public hasWallpaperLayer(Z)V
    .locals 3
    .parameter "wallpaper"
    ...
    const-string v2, "hasWallpaperLayer "
    ...
    .line 1636
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasWallpaper:Z
...
.method public hideDirectRestartDialog()V
    .locals 2
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    invoke-virtual {v2, v3}, Landroid/view/WindowOrientationListener;->setCurrentRotation(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1054
    iput-boolean v7, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasWallpaper:Z
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    .line 2012
    :cond_6
    const-string v3, "ontim.cit.home.test"
    ...
    const-string v5, "cit on going,setprop"

    invoke-static {v3, v5}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 2016
    const-string v3, "ontim.ft.home.press"
    ...
    const-string v5, "cit on going, Ignoring HOME"

    invoke-static {v3, v5}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 2029
    .end local v16           #citHomeTest:I
    .end local v17           #citOnging:I
    ...
    .restart local v16       #citHomeTest:I
    .restart local v17       #citOnging:I
    :cond_7
    const-string v3, "PhoneWindowManager"
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isShowingAndNotHidden()Z
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->isShowing()Z
    ...
    .line 3612
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isSysoffEnable()Z
    ...
    invoke-static/range {v16 .. v16}, Landroid/os/ISysoffMonitor$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/ISysoffMonitor;

    move-result-object v17

    .line 3616
    .local v17, sm:Landroid/os/ISysoffMonitor;
    invoke-interface/range {v17 .. v17}, Landroid/os/ISysoffMonitor;->isSysoffConfig()Z
    ...
    invoke-interface {v0, v1}, Landroid/os/ISysoffMonitor;->setSysonConfig(Z)V

    .line 3621
    new-instance v9, Landroid/content/Intent;

    invoke-interface/range {v17 .. v17}, Landroid/os/ISysoffMonitor;->getSysonIntent()Ljava/lang/String;
    ...
    .end local v17           #sm:Landroid/os/ISysoffMonitor;
    :cond_d
    :goto_6
    if-eqz v13, :cond_e
    ...
    const-string v20, "Failed to fetch the sysoff config status"
    ...
    const-string v21, "interceptKeyBeforeQueueing Power key down: "
    ...
    .line 3763
    .restart local v16       #service:Landroid/os/IBinder;
    invoke-static/range {v16 .. v16}, Landroid/os/ISysoffMonitor$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/ISysoffMonitor;

    move-result-object v17

    .line 3764
    .restart local v17       #sm:Landroid/os/ISysoffMonitor;
    invoke-interface/range {v17 .. v17}, Landroid/os/ISysoffMonitor;->isSysoffConfig()Z
    ...
    :cond_1c
    invoke-interface/range {v17 .. v17}, Landroid/os/ISysoffMonitor;->isSysonConfig()Z
    :try_end_5
...
.method showDirectRestartDialog()V
    .locals 3
    ...
    const-string v2, "showDirectRestartDialog before mGlobalActions.DismissDialog"
    ...
    invoke-virtual {v1}, Lcom/android/internal/policy/impl/GlobalActions;->DismissDialog()V
    ...
    invoke-direct {v2, p0}, Lcom/android/internal/policy/impl/PhoneWindowManager$5;-><init>(Lcom/android/internal/policy/impl/PhoneWindowManager;)V
...
#.method static synthetic access$invoke-updateSystemUiVisibilityLw-70a115(Lcom/android/internal/policy/impl/PhoneWindowManager;)I
#    .locals 1
#    .parameter "x0"
#    .prologue
#    invoke-direct {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->updateSystemUiVisibilityLw()I
