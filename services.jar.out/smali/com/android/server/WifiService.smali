...
.field private static final ICON_NETWORKS_AVAILABLE:I = 0x1080557
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, p0, v9}, Lcom/android/server/WifiService$LockList;-><init>(Lcom/android/server/WifiService;Lcom/android/server/WifiService$1;)V
    ...
    invoke-static {}, Lcom/android/server/WifiService;->getSystemDir()Ljava/io/File;

    move-result-object v5

    const-string v6, "netpolicy.xml"

    invoke-direct {v4, v5, v6}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-direct {v3, v4}, Landroid/util/AtomicFile;-><init>(Ljava/io/File;)V

    iput-object v3, p0, Lcom/android/server/WifiService;->mPolicyFile:Landroid/util/AtomicFile;
    ...
    invoke-direct {v1, v3, v9}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    const-string v6, "android.net.conn.WIFI_VOIP_SWITCH_EVENT"
    ...
    const-string v4, "wifi_use_auto_connect"
    ...
    .line 511
    const-string v3, "net.wifi.autoLink"
...
.method static synthetic access$800(Lcom/android/server/WifiService;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 120
    invoke-direct {p0}, Lcom/android/server/WifiService;->grabWifiHighPerfLock()V
...
.method static synthetic access$900(Lcom/android/server/WifiService;)V
    ...
    .prologue
    .line 120
    invoke-direct {p0}, Lcom/android/server/WifiService;->releaseWifiHighPerfLock()V
...
.method private grabWifiHighPerfLock()V
    ...
    .prologue
    .line 401
    iget-object v0, p0, Lcom/android/server/WifiService;->mWifiHighPerfLock:Landroid/net/wifi/WifiManager$WifiLock;
    ...
    iput-object v0, p0, Lcom/android/server/WifiService;->mWifiHighPerfLock:Landroid/net/wifi/WifiManager$WifiLock;
...
.method public getLastBssidBackup()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Landroid/net/wifi/WifiStateMachine;->getLastBssidBackup()Ljava/lang/String;
...
.method public isDataUsageSelectAP()Z
    ...
    const-string v14, "isDataUsageSelectAP mNetworkInfo = "

    invoke-virtual {v13, v14}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v13

    iget-object v14, p0, Lcom/android/server/WifiService;->mNetworkInfo:Landroid/net/NetworkInfo;
    ...
    .line 1110
    iget-object v12, p0, Lcom/android/server/WifiService;->mNetworkInfo:Landroid/net/NetworkInfo;
    ...
    invoke-static {v12}, Landroid/net/wifi/WifiInfo;->removeDoubleQuotes(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v14, "isDataUsageSelectAP SSID = "
    ...
    :cond_3
    :try_start_0
    iget-object v12, p0, Lcom/android/server/WifiService;->mPolicyFile:Landroid/util/AtomicFile;
    ...
    invoke-interface {v3, v2, v12}, Lorg/xmlpull/v1/XmlPullParser;->setInput(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    .line 1141
    const-string v12, "network-policy"
    ...
    invoke-static {v3, v12}, Lcom/android/server/net/NetworkPolicyManagerService$XmlUtils;->readIntAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)I

    move-result v8

    .line 1143
    .local v8, networkTemplate:I
    const-string v12, "WifiService"
    ...
    const-string v14, "networkTemplate = "
    ...
    invoke-static {v3, v12}, Lcom/android/server/net/NetworkPolicyManagerService$XmlUtils;->readLongAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)J
    ...
    invoke-static {v3, v12}, Lcom/android/server/net/NetworkPolicyManagerService$XmlUtils;->readBooleanAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    .end local v8           #networkTemplate:I
    ...
    const-string v13, "problem reading network policy"
...
.method public declared-synchronized setWifiEnabled(Z)Z
    ...
    const-string v4, "setWifiEnabled true in airplane"
    ...
    invoke-virtual {v3}, Landroid/net/wifi/WifiStateMachine;->modifyWifiState()V
    :try_end_0
