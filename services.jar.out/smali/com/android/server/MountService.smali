...
.field private static final EXTERNAL_SDCARD_DIRECTORY:Ljava/lang/String; = "/storage/sdcard1"
...
.field private mprimarySdcardFirstEject:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 206
    iput-boolean v1, p0, Lcom/android/server/MountService;->mExtSdShare:Z
    ...
    .line 213
    iput-boolean v1, p0, Lcom/android/server/MountService;->mprimarySdcardFirstEject:Z
...
.method static synthetic access$500(Lcom/android/server/MountService;Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private addVolumeLocked(Landroid/os/storage/StorageVolume;)V
    ...
    .line 1335
    .end local v0           #existing:Landroid/os/storage/StorageVolume;
    :cond_0
    iget-object v1, p0, Lcom/android/server/MountService;->mVolumes:Ljava/util/ArrayList;
    ...
    .line 1342
    .restart local v0       #existing:Landroid/os/storage/StorageVolume;
    :cond_1
    return-void
.end method
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    const-string v6, "mount: /storage/sdcard1 sleep 1s"
...
.method private getPrimary()Ljava/lang/String;
    .locals 4
...
.method private handleSystemReady()V
    ...
    .line 543
    .local v4, snapshot:Ljava/util/TreeMap;,"Ljava/util/TreeMap<Ljava/lang/String;Ljava/lang/String;>;"
    monitor-exit v8
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .end local v3           #rc:I
    .end local v4           #snapshot:Ljava/util/TreeMap;,"Ljava/util/TreeMap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .restart local v4       #snapshot:Ljava/util/TreeMap;,"Ljava/util/TreeMap<Ljava/lang/String;Ljava/lang/String;>;"
...
.method private notifyShareAvailabilityChange(Z)V
    ...
    invoke-direct {v8, p0, v4}, Lcom/android/server/MountService$5;-><init>(Lcom/android/server/MountService;Ljava/lang/String;)V
    ...
    .line 1140
    .local v5, path_ex:Ljava/lang/String;
    new-instance v1, Ljava/io/File;

    const-string v8, "/storage/sdcard1"

    invoke-direct {v1, v8}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 1141
    .local v1, dirname:Ljava/io/File;
    ...
    invoke-direct {v8, p0}, Lcom/android/server/MountService$6;-><init>(Lcom/android/server/MountService;)V
    ...
    .line 1111
    .end local v1           #dirname:Ljava/io/File;
    .end local v5           #path_ex:Ljava/lang/String;
    .end local v6           #primary:Landroid/os/storage/StorageVolume;
    :cond_3
...
.method private readStorageListLocked()V
    ...
    :cond_7
    :try_start_5
    invoke-direct/range {p0 .. p0}, Lcom/android/server/MountService;->getPrimary()Ljava/lang/String;
...
.method private sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    .line 1174
    const-string v1, "primary_sdcard_first_eject"

    iget-boolean v2, p0, Lcom/android/server/MountService;->mprimarySdcardFirstEject:Z
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    .line 828
    new-instance v20, Lcom/android/server/MountService$4;
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    invoke-direct {v7, p0, v4, v3, v10}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v10}, Lcom/android/server/MountService;->nap(I)V
    ...
    const-string v11, "ext  sdcard0  unmount fail  "
    ...
    iget-boolean v10, p0, Lcom/android/server/MountService;->mUmsAvailable:Z
    ...
    const-string v11, "usb disconnect"
    ...
    .line 1595
    .local v2, dirname:Ljava/io/File;
    ...
    .line 1597
    .local v9, vs_ex:Ljava/lang/String;
    if-eqz p1, :cond_6
    ...
    iput-boolean v10, p0, Lcom/android/server/MountService;->mExtSdShare:Z
    ...
    invoke-direct {v7, p0, v5, v3, v10}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 1616
    .end local v7           #umscb:Lcom/android/server/MountService$UmsEnableCallBack;
    .end local v9           #vs_ex:Ljava/lang/String;
    :cond_6
    :goto_2
    if-nez p1, :cond_0
    ...
    .line 1630
    .restart local v9       #vs_ex:Ljava/lang/String;
    ...
    iget-boolean v10, p0, Lcom/android/server/MountService;->mExtSdShare:Z
    ...
    const-string v11, "ext sd not share"
    ...
    .line 1636
    :cond_9
    invoke-direct {p0, v5, v3, p1}, Lcom/android/server/MountService;->doShareUnshareVolume(Ljava/lang/String;Ljava/lang/String;Z)V
...
.method public shutdown(Landroid/os/storage/IMountShutdownObserver;)V
    ...
    .line 1458
    iput-boolean v12, p0, Lcom/android/server/MountService;->mprimarySdcardFirstEject:Z
    ...
    .line 1465
    .local v7, snapshot:Ljava/util/TreeMap;,"Ljava/util/TreeMap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    const-string v13, "Shutting down  path = "
    ...
    const-string v13, "Shutting down  state = "
    ...
    .end local v2           #i$:Ljava/util/Iterator;
    .end local v4           #path:Ljava/lang/String;
    .end local v7           #snapshot:Ljava/util/TreeMap;,"Ljava/util/TreeMap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .restart local v7       #snapshot:Ljava/util/TreeMap;,"Ljava/util/TreeMap<Ljava/lang/String;Ljava/lang/String;>;"
