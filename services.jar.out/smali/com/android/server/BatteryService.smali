...
.field private static final MSG_LOWBATTERY_SHUTDOWN:I = 0x12d
...
.field private mShutdownDelay:I

.field private mUpdatesStopped:Z

.field private mUsbOnline:Z

.field private mVeryLowBatteryLevel:I
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 156
    iput-boolean v1, p0, Lcom/android/server/BatteryService;->mHasNotified:Z
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/BatteryService$1;-><init>(Lcom/android/server/BatteryService;Z)V
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->mVeryLowBatteryLevel:I
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->mShutdownDelay:I
...
.method static synthetic access$000(Lcom/android/server/BatteryService;)V
    ...
    .prologue
    .line 86
    invoke-direct {p0}, Lcom/android/server/BatteryService;->shutdownDelay()V
...
.method private processValuesLocked()V
    ...
    iput-boolean v0, p0, Lcom/android/server/BatteryService;->mHasNotified:Z
    ...
    .line 390
    :goto_2
    const-string v0, "ontim.feature.shutdelay.enable"
    ...
    .line 391
    invoke-direct {p0}, Lcom/android/server/BatteryService;->shutdownLowBatteryDelay()V
...
.method private final shutdownDelay()V
    .locals 3
    ...
    const-string v2, "shutdownIfNoPower  111  low battery delay shut down"
...
.method private shutdownIfNoPowerLocked()V
    ...
    const-string v1, "shutdownIfNoPower  000  low battery shut down"
...
.method private shutdownIfOverTempLocked()V
    ...
    const-string v1, "shutdownIfOverTemp    high tempertaure shut down"
...
.method private final shutdownLowBatteryDelay()V
    .locals 4
    ...
    iget v1, p0, Lcom/android/server/BatteryService;->mVeryLowBatteryLevel:I

    if-ge v0, v1, :cond_0

    const/4 v0, 0x7

    invoke-virtual {p0, v0}, Lcom/android/server/BatteryService;->isPowered(I)Z
    ...
    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mHasNotified:Z
    ...
    const-string v2, "Very low notified, level:"
    ...
    iget v2, p0, Lcom/android/server/BatteryService;->mShutdownDelay:I
