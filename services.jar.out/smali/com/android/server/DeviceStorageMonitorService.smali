...
.field private static final DEFAULT_CHECK_INTERVAL_SYSTEM_BOOTED:J = 0x1388L

.field private static final DEFAULT_CHECK_INTERVAL_WHEN_FULL:J = 0x3a98L

.field private static final DEFAULT_CHECK_INTERVAL_WHEN_LOW:J = 0x7530L
...
.field private static final DEFAULT_FULL_THRESHOLD_PERCENTAGE:I = 0x2

.field private static DEFAULT_MSG_THRESHOLD_PERCENTAGE:I = 0x0

.field private static final DEFAULT_RESERVE_BYTES:J = 0x200000L
...
.field private static final MSG_LOW_MEMORY_NOTIFICATION_ID:I = 0x2

.field private static final MSG_PATH:Ljava/lang/String; = "/msg"

.field private static final RESERVE_FILE_PATH:Ljava/lang/String; = "/data/reservedata"

.field public static final SERVICE:Ljava/lang/String; = "devicestoragemonitor"

.field private static final SYSTEM_BOOT_CHECK_WHAT:I = 0x2
...
.field private static final mEnableMsgPartitionProp:Ljava/lang/String; = "ro.mms.partition"

.field private static mMmsPartitionEnable:Z = false

.field private static final mMsgThreshHoldPercentage:Ljava/lang/String; = "ro.mms.threshhold.percentage"

.field private static final mSystemBootCompleteProp:Ljava/lang/String; = "sys.boot_completed"
...
.field private mLastReportedFullMemTime:J
...
.field private mMsgFileStats:Landroid/os/StatFs;

.field private mMsgFreeMem:J

.field private mMsgMemLowFlag:Z

.field private mMsgMemLowThreshold:J

.field private mMsgStorageLowIntent:Landroid/content/Intent;

.field private mMsgStorageOkIntent:Landroid/content/Intent;

.field private mMsgTotalMemory:J

.field private mReserveMem:J
...
.field private mSystemBootCompleted:I
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/DeviceStorageMonitorService;->DEFAULT_MSG_THRESHOLD_PERCENTAGE:I

    .line 106
    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/server/DeviceStorageMonitorService;->mMmsPartitionEnable:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 97
    iput-wide v5, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgTotalMemory:J

    .line 98
    iput-wide v5, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgMemLowThreshold:J

    .line 101
    iput-wide v5, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFreeMem:J

    .line 102
    iput-boolean v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgMemLowFlag:Z
    ...
    iput-wide v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mCheckInterval:J

    .line 155
    iput v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mSystemBootCompleted:I
    ...
    .line 465
    const-string v0, "ro.mms.partition"
    ...
    .line 470
    sget-boolean v0, Lcom/android/server/DeviceStorageMonitorService;->mMmsPartitionEnable:Z
    ...
    iput-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFileStats:Landroid/os/StatFs;

    .line 472
    iget-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFileStats:Landroid/os/StatFs;
    ...
    iget-object v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFileStats:Landroid/os/StatFs;
    ...
    iput-wide v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgTotalMemory:J
    ...
    const-string v1, "com.ontim.intent.action.MSG_STORAGE_LOW"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgStorageLowIntent:Landroid/content/Intent;

    .line 487
    iget-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgStorageLowIntent:Landroid/content/Intent;
    ...
    const-string v1, "com.ontim.intent.action.MSG_STORAGE_OK"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgStorageOkIntent:Landroid/content/Intent;

    .line 489
    iget-object v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgStorageOkIntent:Landroid/content/Intent;
    ...
    .line 492
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->getMemFullThreshold()J

    move-result-wide v0

    iput-wide v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMemFullThreshold:J

    .line 493
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->getMsgMemThreshold()J

    move-result-wide v0

    iput-wide v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgMemLowThreshold:J
    ...
    iget-wide v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mMemFullThreshold:J
    ...
    .line 498
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->getReserveMem()J

    move-result-wide v0

    iput-wide v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mReserveMem:J
...
.method static synthetic access$100(Lcom/android/server/DeviceStorageMonitorService;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 74
    iget v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mSystemBootCompleted:I

    return v0
.end method

.method static synthetic access$102(Lcom/android/server/DeviceStorageMonitorService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 74
    iput p1, p0, Lcom/android/server/DeviceStorageMonitorService;->mSystemBootCompleted:I

    return p1
.end method

.method static synthetic access$200(Lcom/android/server/DeviceStorageMonitorService;JZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 74
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/DeviceStorageMonitorService;->postCheckSystemBooted(JZ)V
...
.method static synthetic access$300(Lcom/android/server/DeviceStorageMonitorService;)V
    ...
    .prologue
    .line 74
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->doMsgMemoryProcess()V
...
.method static synthetic access$702(Lcom/android/server/DeviceStorageMonitorService;J)J
    ...
    .prologue
    .line 74
    iput-wide p1, p0, Lcom/android/server/DeviceStorageMonitorService;->mReserveMem:J
...
.method private final cancelMsgNotification()V
    .locals 3
    ...
    .line 532
    iget-boolean v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgMemLowFlag:Z
    ...
    iget-object v1, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgStorageLowIntent:Landroid/content/Intent;
    ...
    iget-object v1, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgStorageOkIntent:Landroid/content/Intent;
    ...
    iput-boolean v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgMemLowFlag:Z
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/android/server/DeviceStorageMonitorService;->postCheckSystemBooted(JZ)V
...
.method private final checkMemory(Z)V
    ...
    invoke-direct {p0, v8, v2, v3}, Lcom/android/server/DeviceStorageMonitorService;->postCheckMemoryMsg(ZJ)V
    ...
    .line 317
    iget-wide v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mReserveMem:J
    ...
    .line 321
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->fillReserveData()V
    ...
    iput-wide v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mLastReportedFullMemTime:J
    ...
    .line 389
    :cond_8
    iget-wide v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mCheckInterval:J
...
.method private final doMsgMemoryProcess()V
    .locals 4
    ...
    .line 292
    iget-wide v0, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFreeMem:J

    iget-wide v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgMemLowThreshold:J
    ...
    .line 293
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->sendMsgNotification()V
    ...
    .line 295
    :cond_1
    invoke-direct {p0}, Lcom/android/server/DeviceStorageMonitorService;->cancelMsgNotification()V

    goto :goto_0
.end method

.method private fillReserveData()V
    .locals 1
...
.method private getMemFullThreshold()J
    .locals 7

    .prologue
    .line 447
    iget-object v3, p0, Lcom/android/server/DeviceStorageMonitorService;->mContentResolver:Landroid/content/ContentResolver;
...
.method private getMsgMemThreshold()J
    .locals 5

    .prologue
    .line 411
    const-string v2, "ro.mms.threshhold.percentage"

    sget v3, Lcom/android/server/DeviceStorageMonitorService;->DEFAULT_MSG_THRESHOLD_PERCENTAGE:I
    ...
    .line 413
    .local v0, value:J
    sget v2, Lcom/android/server/DeviceStorageMonitorService;->DEFAULT_MSG_THRESHOLD_PERCENTAGE:I
    ...
    .line 417
    :cond_0
    iget-wide v2, p0, Lcom/android/server/DeviceStorageMonitorService;->mMsgTotalMemory:J
...
.method private getReserveMem()J
    .locals 3
    ...
    const-string v1, "/data/reservedata"
...
.method private postCheckSystemBooted(JZ)V
    .locals 4
    .parameter "delay"
    .parameter "bCheck"
    ...
    const-string v2, "postCheckSystemBooted delay:"
...
.method private releaseReserveData()V
    .locals 1

    .prologue
    .line 738
    new-instance v0, Lcom/android/server/DeviceStorageMonitorService$3;

    invoke-direct {v0, p0}, Lcom/android/server/DeviceStorageMonitorService$3;-><init>(Lcom/android/server/DeviceStorageMonitorService;)V
...
.method private final restatDataDir()V
    ...
    sget-boolean v15, Lcom/android/server/DeviceStorageMonitorService;->mMmsPartitionEnable:Z
    ...
    iget-object v15, v0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFileStats:Landroid/os/StatFs;
    ...
    iget-object v0, v0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFileStats:Landroid/os/StatFs;
    ...
    iput-wide v15, v0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFreeMem:J
    :try_end_1
    ...
    iget-wide v0, v0, Lcom/android/server/DeviceStorageMonitorService;->mMsgFreeMem:J
    ...
    iput-wide v15, v0, Lcom/android/server/DeviceStorageMonitorService;->mCheckInterval:J
    ...
    iget-wide v15, v0, Lcom/android/server/DeviceStorageMonitorService;->mLastReportedFreeMem:J
    ...
    iget-boolean v15, v0, Lcom/android/server/DeviceStorageMonitorService;->mMemFullFlag:Z

    if-eqz v15, :cond_7

    move-object/from16 v0, p0

    iget-wide v15, v0, Lcom/android/server/DeviceStorageMonitorService;->mLastReportedFullMemTime:J
    ...
    iget-wide v15, v0, Lcom/android/server/DeviceStorageMonitorService;->mReserveMem:J
    ...
    .line 269
    invoke-direct/range {p0 .. p0}, Lcom/android/server/DeviceStorageMonitorService;->releaseReserveData()V
...
.method private final sendMsgNotification()V
    .locals 3
