...
.field private static final MSG_LIGHT_SENSOR_POLL:I = 0x4
...
.field private static final PROXIMITY_SENSOR_NEGATIVE_DEBOUNCE_DELAY:I = 0x64
...
.field private final mBrightness_ramp_rate_fast:I

.field private final mBrightness_ramp_rate_slow:I
...
.field private mLastUpdateAutoBrightTime:J
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/power/Notifier;Lcom/android/server/LightsService;Lcom/android/server/TwilightService;Lcom/android/server/power/DisplayBlanker;Lcom/android/server/power/DisplayPowerController$Callbacks;Landroid/os/Handler;)V
    ...
    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mLock:Ljava/lang/Object;

    .line 272
    const/4 v4, -0x1

    iput v4, p0, Lcom/android/server/power/DisplayPowerController;->mProximity:I

    .line 275
    const/4 v4, -0x1

    iput v4, p0, Lcom/android/server/power/DisplayPowerController;->mPendingProximity:I
    ...
    iput v4, p0, Lcom/android/server/power/DisplayPowerController;->mLastScreenAutoBrightnessGamma:F

    .line 548
    new-instance v4, Lcom/android/server/power/DisplayPowerController$1;

    invoke-direct {v4, p0}, Lcom/android/server/power/DisplayPowerController$1;-><init>(Lcom/android/server/power/DisplayPowerController;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mAnimatorListener:Landroid/animation/Animator$AnimatorListener;

    .line 812
    new-instance v4, Lcom/android/server/power/DisplayPowerController$2;

    invoke-direct {v4, p0}, Lcom/android/server/power/DisplayPowerController$2;-><init>(Lcom/android/server/power/DisplayPowerController;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mCleanListener:Ljava/lang/Runnable;

    .line 1146
    new-instance v4, Lcom/android/server/power/DisplayPowerController$3;

    invoke-direct {v4, p0}, Lcom/android/server/power/DisplayPowerController$3;-><init>(Lcom/android/server/power/DisplayPowerController;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mOnStateChangedRunnable:Ljava/lang/Runnable;

    .line 1157
    new-instance v4, Lcom/android/server/power/DisplayPowerController$4;

    invoke-direct {v4, p0}, Lcom/android/server/power/DisplayPowerController$4;-><init>(Lcom/android/server/power/DisplayPowerController;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mOnProximityPositiveRunnable:Ljava/lang/Runnable;

    .line 1168
    new-instance v4, Lcom/android/server/power/DisplayPowerController$5;

    invoke-direct {v4, p0}, Lcom/android/server/power/DisplayPowerController$5;-><init>(Lcom/android/server/power/DisplayPowerController;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mOnProximityNegativeRunnable:Ljava/lang/Runnable;

    .line 1324
    new-instance v4, Lcom/android/server/power/DisplayPowerController$7;

    invoke-direct {v4, p0}, Lcom/android/server/power/DisplayPowerController$7;-><init>(Lcom/android/server/power/DisplayPowerController;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mProximitySensorListener:Landroid/hardware/SensorEventListener;

    .line 1341
    new-instance v4, Lcom/android/server/power/DisplayPowerController$8;

    invoke-direct {v4, p0}, Lcom/android/server/power/DisplayPowerController$8;-><init>(Lcom/android/server/power/DisplayPowerController;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mLightSensorListener:Landroid/hardware/SensorEventListener;

    .line 1360
    new-instance v4, Lcom/android/server/power/DisplayPowerController$9;

    invoke-direct {v4, p0}, Lcom/android/server/power/DisplayPowerController$9;-><init>(Lcom/android/server/power/DisplayPowerController;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mTwilightListener:Lcom/android/server/TwilightService$TwilightListener;

    .line 354
    new-instance v4, Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;

    invoke-direct {v4, p0, p1}, Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;-><init>(Lcom/android/server/power/DisplayPowerController;Landroid/os/Looper;)V

    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mHandler:Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;
    ...
    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mSensorManager:Landroid/hardware/SensorManager;
    ...
    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mDisplayManager:Landroid/hardware/display/DisplayManager;
    ...
    iget v5, p0, Lcom/android/server/power/DisplayPowerController;->mScreenBrightnessDimConfig:I
    ...
    iput v4, p0, Lcom/android/server/power/DisplayPowerController;->mBrightness_ramp_rate_slow:I

    .line 380
    iget-boolean v4, p0, Lcom/android/server/power/DisplayPowerController;->mUseSoftwareAutoBrightnessConfig:Z
    ...
    iput v4, p0, Lcom/android/server/power/DisplayPowerController;->mLightSensorWarmUpTimeConfig:I

    .line 406
    .end local v0           #lux:[I
    .end local v2           #screenBrightness:[I
    :cond_1
    invoke-static {v3}, Lcom/android/server/power/DisplayPowerController;->clampAbsoluteBrightness(I)I

    move-result v4

    iput v4, p0, Lcom/android/server/power/DisplayPowerController;->mScreenBrightnessRangeMinimum:I
    ...
    iput-boolean v4, p0, Lcom/android/server/power/DisplayPowerController;->mElectronBeamFadesConfig:Z

    .line 413
    iget-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mSensorManager:Landroid/hardware/SensorManager;
    ...
    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mProximitySensor:Landroid/hardware/Sensor;

    .line 414
    iget-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mProximitySensor:Landroid/hardware/Sensor;
    ...
    iput v4, p0, Lcom/android/server/power/DisplayPowerController;->mProximityThreshold:F
    ...
    iput-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mLightSensor:Landroid/hardware/Sensor;
    ...
    .line 426
    iget-object v4, p0, Lcom/android/server/power/DisplayPowerController;->mTwilight:Lcom/android/server/TwilightService;

    iget-object v5, p0, Lcom/android/server/power/DisplayPowerController;->mTwilightListener:Lcom/android/server/TwilightService$TwilightListener;
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/server/TwilightService;->registerListener(Lcom/android/server/TwilightService$TwilightListener;Landroid/os/Handler;)V
    ...
    .line 397
    .restart local v0       #lux:[I
    .restart local v2       #screenBrightness:[I
    :cond_5
    const/4 v4, 0x0
...
.method static synthetic access$1002(Lcom/android/server/power/DisplayPowerController;F)F
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1100(Lcom/android/server/power/DisplayPowerController;)F
    ...
    .prologue
    .line 69
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mRecentLongTermAverageLux:F

    return v0
.end method

.method static synthetic access$1200(Lcom/android/server/power/DisplayPowerController;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$700(Lcom/android/server/power/DisplayPowerController;)F
    ...
    .prologue
    .line 69
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mLastAmbientLux:F

    return v0
.end method

.method static synthetic access$800(Lcom/android/server/power/DisplayPowerController;JF)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$900(Lcom/android/server/power/DisplayPowerController;)J
    .locals 2
    .parameter "x0"

    .prologue
    .line 69
    iget-wide v0, p0, Lcom/android/server/power/DisplayPowerController;->mLastUpdateAutoBrightTime:J
...
.method private updateAutoBrightness(Z)V
    ...
    iput-wide v2, p0, Lcom/android/server/power/DisplayPowerController;->mLastUpdateAutoBrightTime:J
...
.method private updatePowerState()V
    ...
    iget v6, p0, Lcom/android/server/power/DisplayPowerController;->mBrightness_ramp_rate_slow:I
    ...
    .line 667
    :cond_14
    iget v6, p0, Lcom/android/server/power/DisplayPowerController;->mBrightness_ramp_rate_fast:I
