...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    .line 1322
    .local v0, buttonLightDuration:I
    ...
    .line 1364
    .end local v0           #buttonLightDuration:I
    ...
    .line 1331
    .restart local v0       #buttonLightDuration:I
...
.method private wakeUpNoUpdateLocked(J)Z
    ...
    .line 921
    .local v7, isSysoffEnabled:Z
    const/4 v9, 0x0

    .line 923
    .local v9, sm:Landroid/os/ISysoffMonitor;
    :try_start_0
    ...
    invoke-static {v8}, Landroid/os/ISysoffMonitor$Stub;->asInterface(Landroid/os/IBinder;)Landroid/os/ISysoffMonitor;

    move-result-object v9

    .line 925
    invoke-interface {v9}, Landroid/os/ISysoffMonitor;->isSysoffEnable()Z
    :try_end_0
    ...
    :try_start_1
    invoke-interface {v9}, Landroid/os/ISysoffMonitor;->isSysoffConfig()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-interface {v9}, Landroid/os/ISysoffMonitor;->isSysonConfig()Z
    ...
    const-string v1, "ignoring user activity while system off"
    ...
    const-string v1, "Failed to fetch the sysoff config status"
    ...
    .line 955
    iput v10, p0, Lcom/android/server/power/PowerManagerService;->mWakefulness:I
    ...
    const-string v1, "Failed to fetch the sysoff status"
    ...
    .line 944
    iput-boolean v10, p0, Lcom/android/server/power/PowerManagerService;->mSendWakeUpFinishedNotificationWhenReady:Z
...
# virtual methods
.method public acquireScreenOnBlocker()V
    .locals 1

    .prologue
    .line 1808
    iget-object v0, p0, Lcom/android/server/power/PowerManagerService;->mScreenOnBlocker:Lcom/android/server/power/PowerManagerService$ScreenOnBlockerImpl;

    invoke-virtual {v0}, Lcom/android/server/power/PowerManagerService$ScreenOnBlockerImpl;->acquire()V
...
.method public acquireWakeLock(Landroid/os/IBinder;ILjava/lang/String;Landroid/os/WorkSource;)V
    ...
    const-string v2, "acquireWakeLock,flags="
...
.method public releaseScreenOnBlocker()V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/server/power/PowerManagerService$ScreenOnBlockerImpl;->isHeld()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/power/PowerManagerService$ScreenOnBlockerImpl;->release()V
