...
.method public handleKeyDown(Landroid/view/KeyEvent;I)V
    ...
    .line 485
    const-string/jumbo v6, "ontim.testflags.CIT"
    ...
    const-string/jumbo v6, "ro.bootmode"
    ...
    const-string v5, " handleKeyDown  cit return;"
    ...
    :goto_1
    invoke-virtual {p0, v4, v2}, Landroid/media/AudioManager;->adjustMasterVolume(II)V
    ...
    :goto_2
    invoke-virtual {p0, v4, p2, v2}, Landroid/media/AudioManager;->adjustSuggestedStreamVolume(III)V
    ...
    .line 523
    iget-boolean v5, p0, Landroid/media/AudioManager;->mUseMasterVolume:Z
    ...
    :goto_3
    invoke-virtual {p0, v4}, Landroid/media/AudioManager;->setMasterMute(Z)V
...
.method public handleKeyUp(Landroid/view/KeyEvent;I)V
    ...
    const-string v5, " handleKeyUp  cit return;"
    ...
    invoke-virtual {p0, v5, v4}, Landroid/media/AudioManager;->adjustMasterVolume(II)V
    ...
    .line 562
    .local v2, flags:I
    invoke-virtual {p0, v5, p2, v2}, Landroid/media/AudioManager;->adjustSuggestedStreamVolume(III)V
...
.method public preDispatchKeyEvent(Landroid/view/KeyEvent;I)V
    ...
    const-string v4, " preDispatchKeyEvent   cit return;"
    ...
    iget-wide v3, p0, Landroid/media/AudioManager;->mVolumeKeyUpTime:J
    ...
    .line 472
    invoke-virtual {p0, v7, v8}, Landroid/media/AudioManager;->adjustMasterVolume(II)V

    goto :goto_0

    .line 474
    :cond_4
    invoke-virtual {p0, v7, p2, v8}, Landroid/media/AudioManager;->adjustSuggestedStreamVolume(III)V
